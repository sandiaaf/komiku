...
class CariKomik extends StatefulWidget {
  const CariKomik({super.key});

  @override
  State<StatefulWidget> createState() {
    return _CariKomikState();
  }
}

class _CariKomikState extends State<CariKomik> {
  String _searchQuery = "";
  int _selectedCategory = 0;
  List<Category> _categories = [];
  List<Comic> _comics = [];
  bool _isLoading = true;
  bool isFromBottomNavBar = false;
